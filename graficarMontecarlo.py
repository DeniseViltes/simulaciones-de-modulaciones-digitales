...
fig=plt.figure()
plt.grid(True)
plt.semilogx(EbNoDB, Pe2_PSK, label=f'2-{tipoConstelacion} simulada')
plt.semilogx(EbNoDB, Pe4_PSK, label=f'4-{tipoConstelacion} simulada')
plt.semilogx(EbNoDB, Pe8_PSK, label=f'8-{tipoConstelacion} simulada')
plt.semilogx(EbNoDB, Pe16_PSK, label=f'16-{tipoConstelacion} simulada')
plt.semilogx(EbNoDB, teorica_2_PSK, label=f'2-{tipoConstelacion} teorica')
plt.semilogx(EbNoDB, teorica_4_PSK, label=f'4-{tipoConstelacion} teorica')
plt.semilogx(EbNoDB, teorica_8_PSK, label=f'8-{tipoConstelacion} teorica')
plt.semilogx(EbNoDB, teorica_16_PSK, label=f'16-{tipoConstelacion} teorica')
